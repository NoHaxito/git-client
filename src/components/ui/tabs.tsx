  ...
  return (
    ...
    >
      ...
      <TabsPrimitive.Indicator
        className={cn(
          "-translate-y-(--active-tab-bottom) absolute bottom-0 h-(--active-tab-height) w-(--active-tab-width) translate-x-(--active-tab-left) transition-[width,translate] duration-200 ease-in-out",
          variant === "underline"
            ? "z-10 bg-primary data-[orientation=vertical]:right-(--active-tab-left) data-[orientation=horizontal]:h-0.5 data-[orientation=vertical]:w-0.5 data-[orientation=vertical]:translate-x-[13px] data-[orientation=horizontal]:translate-y-px"
            : "-z-1 left-0 rounded-md bg-background shadow-sm dark:bg-accent"
        )}
